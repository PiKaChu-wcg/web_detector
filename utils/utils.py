...
def preprocess(*image_path, max_size=512, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225),path_or_img=True,img=None):
    ori_imgs = [cv2.imread(img_path) for img_path in image_path] if path_or_img else img
